package io.github.grc.practice.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("grcpractice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("grcpractice");
        ...
        config.getMapConfigs().put("io.github.grc.practice.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
