...
@Configuration
@EnableJpaRepositories("io.github.grc.practice.application.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.github.grc.practice.application.repository.search")
